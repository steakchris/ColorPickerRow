...
public struct ColorPalette {
    var name: String
    var palette : [ColorSpec]
    
    init(name: String, palette: [ColorSpec]) {
        self.name = name
...
public extension ColorPalette {
    public static var defaultColorPalettes: [ColorPalette] = [.iOS, .solarised, .wp8, .flat, .material, .metro]
    
    
    public static var iOS: ColorPalette {
        return ColorPalette(name: "Apple",
    ...
    static var solarised: ColorPalette {
        return ColorPalette(name: "Solarised",
    ...
    public static var wp8: ColorPalette {
        return ColorPalette(name: "WP8",
    ...
    public static var flat: ColorPalette {
        return ColorPalette(name: "Flat",
    ...
    public static var material: ColorPalette {
        return ColorPalette(name: "Material",
    ...
    public static var metro: ColorPalette {
        return ColorPalette(name: "Metro",
                            palette: [ColorSpec(hex: "#a4c400", name: "lime"),
                                      ColorSpec(hex: "#60a917", name: "green"),
                                      ColorSpec(hex: "#008a00", name: "emerald"),
                                      ColorSpec(hex: "#00aba9", name: "teal"),
